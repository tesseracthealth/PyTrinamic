...
class TMCM_1633(Module):
    ...
    def setTargetTorque(self, torque):
        self.setAxisParameter(self.AP_TargetTorque, torque)

    def targetTorque(self):
        return self.axisParameter(self.AP_TargetTorque)

    def actualTorque(self):
        return self.axisParameter(self.AP_ActualTorque)
