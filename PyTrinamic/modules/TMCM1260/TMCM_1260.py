...
class TMCM_1260(tmcl_module, StallGuard2Module, LinearRampModule, MotorControl):
    ...
    def showChipInfo(self):
        print("The TMCM-1260 is a single axis controller/driver module. Voltage supply: 24V")
