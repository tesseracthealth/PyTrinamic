...
class TMC5031_register:
    ...
    COOLCONF_M2    = 0x7D
    DRV_STATUS_M2  = 0x7F
    CHOPCONF       = ( CHOPCONF_M1, CHOPCONF_M2)
    COOLCONF       = ( COOLCONF_M1, COOLCONF_M2)
    IHOLD_IRUN     = ( IHOLD_IRUN_M1, IHOLD_IRUN_M2)
    VCOOLTHRS      = ( VCOOLTHRS_M1, VCOOLTHRS_M2)
    VHIGH          = ( VHIGH_M1, VHIGH_M2)
    SW_MODE        = ( SW_MODE_M1, SW_MODE_M2)
    RAMP_STAT      = ( RAMP_STAT_M1, RAMP_STAT_M2)
    XLATCH         = ( XLATCH_M1, XLATCH_M2)
    MSLUT___       = ( MSLUT___M1, MSLUT___M2)
    MSLUTSEL       = ( MSLUTSEL_M1, MSLUTSEL_M2)
    MSLUTSTART     = ( MSLUTSTART_M1, MSLUTSTART_M2)
